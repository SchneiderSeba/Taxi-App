    ...
    <div className="dark:bg-gray-900">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-1">Gestiona tus viajes del día</p>
        </div>
        <button
          onClick={() => setShowAddModal(true)}
          className="flex items-center gap-2 bg-emerald-600 text-white px-5 py-2.5 rounded-lg font-medium hover:bg-emerald-700 transition-all duration-200 shadow-md hover:shadow-lg dark:bg-emerald-800 dark:hover:bg-emerald-900"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-200">Pendientes</span>
          </div>
          <p className="text-3xl font-bold text-gray-900 dark:text-white">{pendingTrips.length}</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-200">Completados</span>
          </div>
          <p className="text-3xl font-bold text-gray-900 dark:text-white">{completedTrips.length}</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-200">Ingresos</span>
          </div>
          <p className="text-3xl font-bold text-emerald-600 dark:text-emerald-300">${totalIncome.toFixed(2)}</p>
        </div>
        ...
        {todayTrips.length === 0 && (
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-12 text-center">
            <div className="w-16 h-16 bg-gray-100 dark:bg-gray-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <MapPin className="w-8 h-8 text-gray-400 dark:text-gray-600" />
            </div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">No hay viajes registrados hoy</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-6">Comienza agregando tu primer viaje del día</p>
            <button
              onClick={() => setShowAddModal(true)}
              className="inline-flex items-center gap-2 bg-emerald-600 text-white px-5 py-2.5 rounded-lg font-medium hover:bg-emerald-700 dark:bg-emerald-800 dark:hover:bg-emerald-900 transition-all duration-200"
            >
              <Plus className="w-5 h-5" />
              Agregar Viaje
            </button>
