          ...
          {activeTab === 'settings' && (
            <div className="space-y-6">
                    ...
                    {editMode ? (
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={(e) => setTempSettings({ ...tempSettings, insuranceMonthly: parseFloat(e.target.value) || 0 })}
                    ...
                    {editMode ? (
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={(e) => setTempSettings({ ...tempSettings, registrationMonthly: parseFloat(e.target.value) || 0 })}
                          className="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 outline-none bg-white"
                          step="0.01"
                          min="0"
                        />
                  ...
                  {editMode ? (
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={(e) => setTempSettings({ ...tempSettings, gasUnitCost: parseFloat(e.target.value) || 0 })}
                        className="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 outline-none bg-white"
                        step="0.01"
                        min="0"
                      />
              ...
              <ExpenseTracker
                ...
                gasUnitCost={settings.gasUnitCost}
              />
            </div>
          )}
