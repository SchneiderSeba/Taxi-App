...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 flex items-center justify-center p-3 sm:p-4 transition-colors">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl sm:rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-5 sm:p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 sm:gap-3 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-700 rounded-lg px-4 sm:px-6 py-3 sm:py-3.5 text-gray-700 dark:text-gray-200 font-medium hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-400 dark:hover:border-gray-500 transition-all duration-200 hover:shadow-md text-sm sm:text-base min-h-[48px]"
          >
          ...
          <form onSubmit={handleRegister} className="space-y-3 sm:space-y-4">
            <input
              type="email"
              className="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-3 sm:px-4 py-2.5 sm:py-3 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-400 text-sm sm:text-base min-h-[44px]"
